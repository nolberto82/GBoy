...
namespace rlImGui_cs
{
    public static class rlImGui
    {
        ...
        public static void ImageRenderTextureFit(RenderTexture2D image, bool center = true, bool flipped = false)
        {
            ...
            ImageRect(image.Texture, sizeX, sizeY, new Rectangle(0, 0, image.Texture.Width, flipped ? -image.Texture.Height : image.Texture.Height));
        }
